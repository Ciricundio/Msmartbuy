window.addEventListener('DOMContentLoaded', () => {
    ...
    if( rol == "cliente"){
        if( genero == "masculino"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/1-Cliente/masculino.svg">';
        }if(genero == "femenino"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/1-Cliente/femenino.svg">';
        }if(genero == "otro"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/1-Cliente/otro.svg">';
        }
    }if( rol == "proveedor"){
        if( genero == "masculino"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/2-Proveedor/masculino.svg">';
        }if(genero == "femenino"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/2-Proveedor/femenino.svg">';
        }if(genero == "otro"){
            img.innerHTML = '<img src="../../public/img/Ilustraciones/2-Proveedor/otro.svg">';
        }
    }
